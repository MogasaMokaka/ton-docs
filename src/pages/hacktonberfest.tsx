  ...
  return (
    <Layout title={"Hack-TON-berfest 🎃"} description={"Welcome to Hack-TON-berfest! Join a month-long celebration of open-source projects, their maintainers, and the entire community of contributors! Each October, open source maintainers give new contributors extra attention as they guide developers through their first pull requests."}>
      <div className="bootstrap-wrapper">
        ...
        <p style={{ textAlign:'center', fontWeight: '400', fontSize:'18px', marginBottom: '20px' }}>Choose your path to start journey:</p>
        <div className="container">
          ...
          <div style={{ marginTop: '50px' }}>
            ...
            <p style={{ textAlign:'center', fontWeight: '400', fontSize:'18px', marginBottom: '20px' }}>Here is a list of repositories in TON Ecosystem who awaits of contributors right now:</p>
          ...
          <div style={{ marginTop: '50px' }}>
            ...
            <p style={{ textAlign:'center', fontWeight: '400', fontSize:'18px', marginBottom: '20px' }}>Please, read the page for maintainers and fill the form — <a href={"/contribute/hacktoberfest/as-maintainer"}>join as maintainer</a>. It's easy now!</p>
          </div>
          <div style={{ marginTop: '50px' }}>
            <h1 style={{ fontWeight: '650', textAlign:'center', padding: '0 10px' }}>Claim your NFT as proof of participating 💎</h1>
            <p style={{ textAlign:'center', fontWeight: '400', fontSize:'18px', maxWidth:'600px', margin:'0 auto', marginBottom: '20px' }}>Every participant (maintainer and contributor) to any of TON Ecosystem projects will receive <b><a href="/contribute/hacktoberfest/#what-the-rewards">Limited Hack-TON-berfest NFT</a></b>:</p>
          ...
          <div style={{ marginTop: '50px' }}>
            ...
            <p style={{ textAlign:'center', fontWeight: '400', fontSize:'18px', marginBottom: '20px' }}>Before asking any question in the chats, please read answers here first.</p>
            ...
            <p style={{ textAlign:'center', fontWeight: '400', fontSize:'18px', marginTop: '20px' }}>If you have any specific questions, feel free to ask in <a href={"https://t.me/TonDev_eng"}>TON Dev Chat</a> to get help.</p>
          </div>
        </div>
      </div>
    </Layout>
